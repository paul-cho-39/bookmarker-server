...
const getAllBooks = (uid) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield (0, action_1.read)(`
       ...
       RETURN COLLECT(DISTINCT(b1.id)) as current, COLLECT(DISTINCT(b2.id)) as want, COLLECT(DISTINCT(b3.id)) as finished
       `, {
        uid: uid,
    });
    return result;
...
const getCurrentBooks = (uid) => __awaiter(void 0, void 0, void 0, function* () {
    return yield (0, action_1.read)(`
      MATCH (u:User { uid: $uid })-[rel:CURRENTLY_READING]-(book:Book:Book)-[:WROTE]-(a:Author:Author)
      WITH book, a.name as author, rel.dateAdded AS unconvertedDate
      RETURN 
         DISTINCT(book.title) as title, 
