...
class BookWrite {
    ...
    createAuthors() {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function* () {
            const authors = (_a = this.data) === null || _a === void 0 ? void 0 : _a.authors;
            if (!authors)
                return;
            ...
            `, {
                authors: (_b = this.data) === null || _b === void 0 ? void 0 : _b.authors,
            });
        });
    }
    ...
    createCategories() {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const categories = (_a = this.data) === null || _a === void 0 ? void 0 : _a.categories;
            if (!categories)
                return;
            yield this._executeQueryWithoutUid(`
         MATCH (book:Book { id: $id })
