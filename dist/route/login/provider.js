...
const userData_1 = require("../../model/auth/userData");
const action_1 = require("../../config/action");
const userAction_1 = require("../../model/auth/userAction");
const firebase_admin_1 = __importDefault(require("firebase-admin"));
const route = express_1.default.Router();
route.use('/user/provider', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
...
route.post('/user/provider', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const data = req.data;
    if (req.isNewUser) {
